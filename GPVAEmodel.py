...
def build_sin_and_np_elbo_graphs(vid_batch, beta, lt=5, context_ratio=0.5):
    ...
    print('BHU', sin_elbo_recon.shape, sin_elbo_prior_kl.shape, recon_err.shape, vid_batch.shape)
    ...
    #####################################################################################
    ####################### PUT IT ALL TOGETHER  ########################################
    print('BHU', sin_elbo_recon.shape, sin_elbo_prior_kl.shape)
    sys.exit(0)
